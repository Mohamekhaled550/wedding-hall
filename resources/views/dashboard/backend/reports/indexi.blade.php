...
<div class="container">
    ...
    <form action="{{ route('admin.reports.searchi') }}" method="POST">
        @csrf
        <div class="row mb-4">
            <div class="col-md-4">
            ...
            <table class="table align-middle gs-0 gy-4">
                ...
                <tbody>
                    @forelse ($invoices as $invoice)
                        @if ($invoice->section->name == 'Hall 2')  
                            <tr>
                ...
                <tr>
                    ...
                    <td colspan="4" class="text-end fw-bold text-primary">
                        {{ isset($totalAmoun) ? number_format($totalAmoun, 2) : '0.00' }}
                    </td>                        </tr>
            </table>
        </div>
    @endisset
