        ...
        <form action="{{ route('admin.invoices.store') }}" autocomplete="off" method="POST" class="form fv-plugins-bootstrap5 fv-plugins-framework" enctype="multipart/form-data">
            ...
            <div class="row">
                    ...
                    <div class="d-flex flex-wrap gap-5">
                        <div class="fv-row w-100 flex-md-root fv-plugins-icon-container">
                            ...
                            <select class="form-select mb-2 select2-hidden-accessible" name="section_id" id="section_id" data-control="select2" data-hide-search="true" data-placeholder="Select an option" data-select2-id="select2-data-16-dzu5" tabindex="-1" aria-hidden="true">
                                <option value="" disabled selected> -- اختر من الاقسام -- </option>
                ...
                <div class="d-flex col-4 flex-column mb-7 fv-row fv-plugins-icon-container">
                    ...
                    <input type="text" id="Amount_Commission" name="Amount_Commission" value="{{ old('Amount_Commission') }}" class="form-control form-control-solid" placeholder="Enter Amount Commission" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
            ...
            <div class="row">
                ...
                <div class="d-flex col-4 flex-column mb-7 fv-row fv-plugins-icon-container">
                    ...
                    <input type="text" name="Amount_collection" value="{{ old('Amount_collection') }}" class="form-control form-control-solid" placeholder="Enter Amount collection" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" >
            ...
            <div class="row">
                ...
                <div class="d-flex col-6 flex-column mb-7 fv-row fv-plugins-icon-container">
                    ...
                    <input type="text" name="value_vat" value="" class="form-control form-control-solid" placeholder="Enter value vat"  id="Value_VAT" readonly>
